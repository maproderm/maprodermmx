            ...
            <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
                ...
                <div class="d-flex align-items-center order-2 order-md-1">
                    ...
                    <a href="https://maproderm.com/">
                        {{-- <img alt="Logo" src="metronic/assets/media/logos/landing.svg" class="h-15px h-md-20px" /> --}}
                        <img alt="Logo" src="metronic/assets/media/logos/logo-blanco.png" class="h-25px h-md-30px" />
                    </a>
                    <!--end::Logo image-->
                    <!--begin::Logo image-->
                ...
                <ul class="menu menu-gray-600 menu-hover-primary fw-semibold fs-6 fs-md-5 order-1 mb-5 mb-md-0">
                    ...
                    <li class="menu-item mx-5">
                        <a href="https://wa.me/message/V64WQZ2OHK4LP1" target="_blank" class="menu-link px-2">Soporte</a>
                    </li>
                    <li class="menu-item">
                        <a href="https://maproderm.com/" target="_blank" class="menu-link px-2">Tienda</a>
                    </li>
                </ul>
                <!--end::Menu-->
            </div>
