@extends('index')
@section('title','Inicio | MaProDerm')
@section('content')
        ...
        <div class="card" style="filter: drop-shadow(0px 0px 40px rgba(68, 81, 96, 0.08))">
            ...
            <div class="card-body p-lg-20">
                ...
                <div class="text-center mb-5 mb-lg-10">
                    <!--begin::Title-->
                    <h3 class="fs-2hx text-dark mb-5" id="productos" data-kt-scroll-offset="{default: 100, lg: 250}">Productos</h3>
                    <!--end::Title-->
                </div>
                <!--end::Heading-->
                <!--begin::Tabs wrapper-->
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="kt_landing_projects_latest">
                        ...
                        <div class="row g-10">
                            ...
                            <div class="col-lg-6">
                                <!--begin::Item-->
                                {{-- <a class="d-block card-rounded overlay h-lg-100" data-fslightbox="lightbox-projects" href="metronic/assets/media/stock/600x600/img-23.jpg"> --}}
                                <a class="d-block card-rounded overlay h-lg-100" xdata-fslightbox="lightbox-projects" href="https://maproderm.com/ofertas/">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-lg-100 min-h-250px" style="background-image:url('metronic/assets/media/stock/600x600/products.jpg')"></div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="row g-10 mb-10">
                                    ...
                                    <div class="col-lg-6">
                                        <!--begin::Item-->
                                        {{-- <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="metronic/assets/media/stock/600x600/aloe.jpg"> --}}
                                        <a class="d-block card-rounded overlay" xdata-fslightbox="lightbox-projects" href="https://maproderm.com/shop/aloe-vera-30ml/">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('metronic/assets/media/stock/600x600/aloe.jpg')"></div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-5">
                                                {{-- <i class="bi bi-eye-fill fs-3x text-white"></i> --}}
                                    ...
                                    <div class="col-lg-6">
                                        <!--begin::Item-->
                                        {{-- <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="metronic/assets/media/stock/600x600/argan.jpg"> --}}
                                        <a class="d-block card-rounded overlay" xdata-fslightbox="lightbox-projects" href="https://maproderm.com/shop/gold-argan-10ml/">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('metronic/assets/media/stock/600x600/argan.jpg')"></div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-5">
                                                {{-- <i class="bi bi-eye-fill fs-3x text-white"></i> --}}
                                ...
                                <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="https://maproderm.com/categoria-producto/ojos/universal-color/">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('metronic/assets/media/stock/600x600/universal.jpg')"></div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-5">

                                        {{-- <a href="https://maproderm.com/categoria-producto/ojos/universal-color/"><i class="bi bi-eye-fill fs-3x text-white"></i></a> --}}
                                    </div>
                                    <!--end::Action-->
                                </a>
                                <!--end::Item-->
                        ...
                        <div class="row g-10">
                            ...
                            <div class="col-lg-6">
                                ...
                                <a class="d-block card-rounded overlay h-lg-100" data-fslightbox="lightbox-projects" href="assets/media/stock/600x600/img-11.jpg">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-lg-100 min-h-250px" style="background-image:url('metronic/assets/media/stock/600x600/img-11.jpg')"></div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="row g-10 mb-10">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="assets/media/stock/600x600/img-12.jpg">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('metronic/assets/media/stock/600x600/img-12.jpg')"></div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                <i class="bi bi-eye-fill fs-3x text-white"></i>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="assets/media/stock/600x600/img-21.jpg">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('metronic/assets/media/stock/600x600/img-21.jpg')"></div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                <i class="bi bi-eye-fill fs-3x text-white"></i>
                                ...
                                <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="assets/media/stock/600x400/img-20.jpg">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('metronic/assets/media/stock/600x600/img-20.jpg')"></div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        <i class="bi bi-eye-fill fs-3x text-white"></i>
                                ...
                                <div class="row g-10 mb-10">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="assets/media/stock/600x600/img-16.jpg">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('metronic/assets/media/stock/600x600/img-16.jpg')"></div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                <i class="bi bi-eye-fill fs-3x text-white"></i>
